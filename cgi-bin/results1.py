...
for i in range(100):
 ...
 # classval2=testclassval2[i]
  ...
  trndata1.appendLinked([40,1], [0])
  trndata1.appendLinked([40,2], [0])
  trndata1.appendLinked([40,3], [0])
  trndata1.appendLinked([40,4], [2])
  trndata1.appendLinked([400,1], [1])
  trndata1.appendLinked([400,2], [1])
  trndata1.appendLinked([400,3], [1])
  trndata1.appendLinked([400,4], [2])
  trndata1.appendLinked([4000,1], [2])
  trndata1.appendLinked([4000,2], [2])
  trndata1.appendLinked([4000,3], [2])
  trndata1.appendLinked([4000,4], [2])
  trndata1._convertToOneOfMany()

  tstdata1=ClassificationDataSet(2,class_labels=classes1)
  tstdata1.appendLinked([code, attempts],[classval])
...
#  print 'class', classes[classval]
  message=''
  if trnresult1==0.0 and tstresult1==0.0:
    if classes1[classval]=='valid':
      message='valid'
      valid=valid+1
    elif classes1[classval]=='invalid':
      message='invalid'
      invalid=invalid+1
    elif classes1[classval]=='malicious':
      message='malicious'
