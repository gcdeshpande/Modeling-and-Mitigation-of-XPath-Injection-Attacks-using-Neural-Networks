...
message=''
if tstresult1==0.0 and tstresult2==0.0:
  if classes1[classval]=='valid' and classes2[classval2]=='valid':
    message='valid'
  elif classes1[classval]=='valid' and classes2[classval2]=='malicious':
    message='malicious'
  elif classes1[classval]=='invalid' and classes2[classval2]=='valid':
    message='invalid'
  elif classes1[classval]=='invalid' and classes2[classval2]=='malicious':
    message='malicious'
